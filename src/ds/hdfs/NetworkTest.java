...
public class NetworkTest implements temporaryInterface{
	...
	public static void main(String[] args) throws RemoteException,InterruptedException, UnknownHostException{
		...
		System.setProperty("java.rmi.server.hostname", "10.1.39.21");
		...
		try {
			...
			serverObj.serverRegistry = LocateRegistry.getRegistry(2003);
		...
		while(!found)
		try {
			Registry registry2 = LocateRegistry.getRegistry("10.1.39.133",2004);
